...
public class client {
	...
	public static void main(String[] args) {
		...
		ITStaffFactory simpleFactory = new ITStaffFactory();
...
//					staffList.add(new ITManager());
					staffList.add(simpleFactory.createITStaff(1));
					break;
				case 2:
//					staffList.add(new Developer());
					staffList.add(simpleFactory.createITStaff(2));
					break;
				case 3:
//					staffList.add(new Tester());
					staffList.add(simpleFactory.createITStaff(3));
					break;
				case 4:
